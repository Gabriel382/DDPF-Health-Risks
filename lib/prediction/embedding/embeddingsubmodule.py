class ObservationEmbeddingSubModule:
    ...
    def applyEmbedding(self, df_obs, df_kb, df_net, include_spatial=True, include_temporal=True):
        """
        Public method to compute embeddings given the observation and embedding DataFrames.
        """
        return self._applyEmbedding(df_obs, df_kb, df_net,include_spatial,include_temporal)